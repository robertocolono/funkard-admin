...
import { User, Lock, Unlock, MessageSquare } from 'lucide-react';
...
export function TicketRow({ ticket, onUpdate }: TicketRowProps) {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 flex justify-between items-center hover:bg-zinc-800 transition-colors">
